...
class TrackingRepeatedFullOrder(BlimpController):
    ...
    def init_sim(self, sim):
        ...
        max_allowable_x_dev = 0.25
        max_allowable_y_dev = 0.25
        max_allowable_z_dev = 0.25

        max_allowable_theta = 0.01
        max_allowable_phi = 0.01
        ...
        self.Q = np.eye(12)
        self.Q[0, 0] = 1/(max_allowable_vx**2)
        self.Q[1, 1] = 1/(max_allowable_vy**2)
        self.Q[2, 2] = 1/(max_allowable_vz**2)
        self.Q[3, 3] = 1/(max_allowable_wx**2)
        self.Q[4, 4] = 1/(max_allowable_wy**2)
        self.Q[5, 5] = 1/(max_allowable_wz**2)
        self.Q[6, 6] = 1/(max_allowable_x_dev**2)
        self.Q[7, 7] = 1/(max_allowable_y_dev**2)
        self.Q[8, 8] = 1/(max_allowable_z_dev**2)
        self.Q[9, 9] = 1/(max_allowable_phi**2)
        self.Q[10, 10] = 1/(max_allowable_theta**2)
